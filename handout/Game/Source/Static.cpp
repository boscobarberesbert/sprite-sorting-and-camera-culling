...
Static::Static(int x, int y, std::string name) :Entity(Types::STATIC, x, y, name)
{
	...
	//TODO 3: Create a building on Tiled and integrate in code
	/*Warnings:
				...
				Texture rect for building is: (128, 169, 48, 41)
				Correct pivot might be (24, 39) (we will see what it is for later)
	*/
